...
// Mega 2560 is connected to the onboard ESP8266 via serial port 3
// Taken from https://docs.arduino.cc/built-in-examples/communication/SerialEvent
void serialEvent3()
{
...
void loop() {
  ...
  if (count > count_prev) {
    ...
    linearSpeed = linearMax * throttleValue;
    angularSpeed = angularMax * steeringValue;
  ...
  // Values we want to transmit to ESP
